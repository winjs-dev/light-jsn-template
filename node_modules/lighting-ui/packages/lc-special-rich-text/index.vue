...
<template>
  <div class="lc-special-rich-text">
    <div class="tag-div"
         :style="{top:top+'px'}">
      <lc-rich-text-icon v-if="newList[0].type == 'icon' && newList[0].src"
                          :icon-src="newList[0].src"
                          :icon-style="newList[0].style"></lc-rich-text-icon>
      <lc-rich-text-tag v-if="newList[0].type=='tag' && newList[0].value"
                         :tag-value="newList[0].value"
                         :tag-theme="newList[0].theme"
                         :tag-style="newList[0].style"></lc-rich-text-tag>
    </div>
...
<script>
  ...
  import LcRichTextText from '../lc-rich-text/lc-rich-text-text.vue';
  import LcRichTextIcon from '../lc-rich-text/lc-rich-text-icon.vue';
  import LcRichTextTag from '../lc-rich-text/lc-rich-text-tag.vue'

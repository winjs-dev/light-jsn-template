...
<template>
  <div class="lc-page-calendar"
       ref="pageCalendar">
    <lc-minibar :show="showTitle"
                 v-bind="minibarCfg"
                 :use-default-return="false"
                 @LcMinibarLeftButtonClicked="minibarLeftButtonClick"></lc-minibar>
...
<script>
  ...
  import LcMinibar from '../lc-minibar'
  ...
  export default {
    ...
    methods: {
      minibarLeftButtonClick () {
        setTimeout(() => {
          this.hide();
          this.$emit('LcPageCalendarBackClicked', {});
        }, 100);
      },
      ...
      dispatchDateChange (dateArr) {
        ...
        this.$emit('LcPageCalendarDateSelected', {
          date: dateArr
        });
      },
      detectShow () {

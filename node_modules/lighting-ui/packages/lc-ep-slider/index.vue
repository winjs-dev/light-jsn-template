...
<script>
  ...
  //114743 lighting-ui组件lc-ep-slider在安卓下使用pan-item时，点击事件会与滑动事件冲突导致不能滑动
  ...
  export default {
    ...
    methods: {
      onPanStart (e) {
        this.$emit('LcEpSliderOnPanStart', { currentIndex: this.currentIndex });
      ...
      onPanMove (e) {
        this.$emit('LcEpSliderOnPanMove', { currentIndex: this.currentIndex });  
        if (BindEnv.supportsEB()) {
          return;
        }
      ...
      onEpPanStart (e) {
        this.$emit('LcEpSliderOnEpPanStart', { currentIndex: this.currentIndex });
      ...
      onPanEnd (e) {
        ...
        this.panEnd(e);
        this.$emit('LcEpSliderOnPanEnd', { currentIndex: this.currentIndex });
      },
      panEnd (e) {
        this.isMoving = true;
        let moveX = e.deltaX;
        ...
        if(isPullMore){
            this.$emit('LcEpSliderPullMore', { currentIndex: selectIndex });
        }
      ...
      slideTo (originIndex, selectIndex) {
        ...
        this.$emit('LcEpSliderCurrentIndexSelected', { currentIndex: selectIndex });

    ...
    methods: {
      onBlur () {
        ...
        setTimeout(() => {
          ...
          self.$emit('LcSearchbarInputOnBlur', { value: self.value });
        }, 10);
      },
      autoBlur () {
      ...
      onFocus () {
        ...
        this.$emit('LcSearchbarInputOnFocus', { value: this.value });
      },
      closeClicked () {
        this.value = '';
        this.showCancel && (this.showCancel = false);
        this.showClose && (this.showClose = false);
        this.$emit('LcSearchbarCloseClicked', { value: this.value });
        this.$emit('LcSearchbarInputOnInput', { value: this.value });
      },
      onInput (e) {
        this.value = e.value;
        this.showCancel = true;
      ...
      onSubmit (e) {
        ...
        this.showCancel = true;
        this.detectShowClose();
        this.$emit('LcSearchbarInputReturned', { value: this.value });
      },
      cancelClicked () {
        this.showCancel && (this.showCancel = false);
        this.showClose && (this.showClose = false);
        this.$emit('LcSearchbarCancelClicked', { value: this.value });
      },
      detectShowClose () {
        this.showClose = (this.value.length > 0) && this.showCancel;
      },
      depClicked () {
        this.$emit('LcSearchbarDepChooseClicked', {});
      },
      inputDisabledClicked () {
        this.$emit('LcSearchbarInputDisabledClicked', {});
      },
      setValue (value) {
        this.value = value;
      }
